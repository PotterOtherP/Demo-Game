class StringList {
	...
	public static final String INTRO = "Welcome to the cave game.\nYou awaken in a red room.";
	public static final String DESCREDROOM = "This is a red room. There are exits in all four directions.";
